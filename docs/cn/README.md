...
4. [Knowledge](knowledge/) 与 [Services](services/)：检索增强回答、HTTP 与流式服务暴露。
5. [Observability](observability/) 与 [Development](development/)：Event Center、DevTools 与 coding-agent 指引。
